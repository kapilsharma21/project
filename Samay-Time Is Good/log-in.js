...
function onLoad() {
    { // function to check if user email matches with the registered email
        ...
        if ((emailData == "" || emailData != "hydrogen@gmail.com")) {
            ...
            if ((emailData == "" || emailData != "kapil9193277@gmail.com")) {
                btn1.disabled = true //if user input does not match, log-in button is disabled
                email.style.border = 1 + "px solid red"
                pswd.style.border = 1 + "px solid red"
                if ((emailData == "" || emailData != "samay@gmail.com")) {
                    btn1.disabled = true //if user input does not match, log-in button is disabled
                    email.style.border = 1 + "px solid red"
                    pswd.style.border = 1 + "px solid red"
                } else {
...
function validateUser(event) {
    ...
    //     }
        ...
        window.location = "timetracker.html"
    }
