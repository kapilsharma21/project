...
const showAllData = () => {
        ...
        document.getElementById("dashboard__stats__total__time").innerHTML = sumTotal + ` second`
        document.getElementById("dashboard__stats__average__time").innerHTML = Math.floor(sumTotal / 7) + ` second`;
        ...
        let secDay = weeklyDataReport[0][0]
        let secTime = weeklyDataReport[0][1]
        ...
        <div>   
            ...
            <h2 id="dashboard__stats__total__time">${sumTotal} sec</h2>
        </div>
        <div>
            <span>Average Time</span>
            <h2 id="dashboard__stats__average__time">${Math.floor(sumTotal/2) +` sec`}</h2>
        </div>
        ...
        <ul>
            ...
            <li>The time spent is <b>${maxTime} second</b> </li>
        </ul>
        </div>
        <div>
        <ul>
            <h3>Least</h3>
            <li>You have spent the least of your time on <b>${secDay}</b></li>
            <li>The time spent is <b>${secTime} second </b> </li>
        </ul>
        </div>
        `
...
const filterByProjectName = ()=>{
    ...
    if(selectedProject === ""){
        ...
        totalTime = dataCollector.reduce((acc,item) =>{
         ...
         document.getElementById("dashboard__stats__total__time").innerHTML = totalTime +` sec`;
         document.getElementById("dashboard__stats__average__time").innerHTML = Math.floor(totalTime/7) +` sec`;
    ...
    let secDay = dataCollectorStats[0][0]
    let secTime = dataCollectorStats[0][1]
    let secDesc = dataCollectorStats[0][2]
    ...
    dashboardReport.innerHTML = `
                ...
                <ul>
                    <h3>Most</h3>
                    <li>You have spent the most of your time on <b>${maxDay}</b></li>
                    <li>The time spent is <b>${maxTime} seconds</b> </li>
                ...
                <ul>
                    <h3>Least</h3>
                    <li>You have spent the least of your time on <b>${secDay}</b></li>
                    <li>The time spent is <b>${secTime} Minutes </b> </li>
